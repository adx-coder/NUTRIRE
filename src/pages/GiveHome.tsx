    ...
    <main className="min-h-screen relative overflow-hidden" style={{ background: GLASS_BG }}>
      ...
      <div className="relative z-10">
        <motion.nav initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}
          className="px-3 sm:px-5 lg:px-10 pt-4 sm:pt-5">
        ...
        <div className="max-w-2xl mx-auto px-3 sm:px-5 lg:px-10 pt-10 sm:pt-14 lg:pt-20 pb-16 sm:pb-20 text-center">
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease }}>
            <p className="text-[10px] font-bold uppercase tracking-[0.16em] text-sage-deep/50">{t("give.eyebrow")}</p>
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-lg mx-auto">
            <motion.button onClick={() => navigate("/give/donate")}
              ...
              <h2 className="mt-4 font-display text-[18px] font-semibold text-ink">{t("give.donate.title")}</h2>
              <p className="mt-1.5 text-[12px] text-ink/55 leading-relaxed">{t("give.donate.desc")}</p>
              <div className="mt-4 inline-flex items-center gap-1 text-[12px] font-semibold text-sage-deep">
                {t("give.donate.cta")} <ArrowUpRight size={13} className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
              </div>
            </motion.button>
            ...
            <motion.button onClick={() => navigate("/give/volunteer")}
              ...
              <h2 className="mt-4 font-display text-[18px] font-semibold text-ink">{t("give.vol.title")}</h2>
              <p className="mt-1.5 text-[12px] text-ink/55 leading-relaxed">{t("give.vol.desc")}</p>
              <div className="mt-4 inline-flex items-center gap-1 text-[12px] font-semibold text-ink-soft group-hover:text-ink">
                {t("give.vol.cta")} <ArrowUpRight size={13} className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
              </div>
            </motion.button>
          </div>
        </div>
